...
import { AlertTriangle, Zap, Flame, Droplets, ArrowRight } from 'lucide-react';
...
const MajorAlerts: React.FC<MajorAlertsProps> = ({ calamities, predictions }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <button className="w-full py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 text-[9px] font-orbitron border border-red-500/30 rounded flex items-center justify-center gap-2 transition-all">
        DOWNLOAD ALERT LOG <ArrowRight size={10} />
      </button>
    </div>
  );
};
